...
Problem with being a research PhD candidate is that it is hard to answer the
...
impressed with Haskell programming language. I have quite some
in-front-of-the-screen time writing code and wrapping my head around various
