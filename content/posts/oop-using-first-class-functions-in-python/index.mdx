...
in a compact way using Python's support for FP located inside the `functools`
module:

```py noLineNumbers
>>> from functools import reduce
>>> pink_tulip_after_4cup_compact = reduce(water, (1,1,1,1), pink_tulip)
>>> measure(pink_tulip_after_4cup_compact)
11.25
```

In this example we've used the powerful
[`functools.reduce`](https://docs.python.org/3/library/functools.html#functools.reduce)
function to call make recursive function calls.
